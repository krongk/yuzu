class ProductsController < ApplicationController
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:user_id, :cate_id, :title, :mobile_phone, :email, :content, :price, :region_id, :city_id, :city_name, :district_id, :detail_address, :is_processed)
    end
end
